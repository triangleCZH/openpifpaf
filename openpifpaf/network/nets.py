...
def factory_from_args(args):
    ...
    return factory(
        ...
        head_names=args.headnets, #pif paf paf25
...
def factory_from_scratch(basename, headnames, *, pretrained=True):
    ...
    if 'mobilenetv1' in basename:
        return mobilenet_factory_from_scratch(basename, None, 3072, headnames)        
...
def shufflenet_factory_from_scratch(basename, base_vision, out_features, headnames):
    print('shufflenet', basename, base_vision, out_features, headnames)
...
# base_vision is a pre-constrcuted model, i.e., resnet18, pretrained or not
